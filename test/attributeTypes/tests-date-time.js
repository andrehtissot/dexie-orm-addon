...
test("AttributeTypes.DateTime.validate", ( assert ) => {
    ...
    typeValidateOk(assert, DateTime, options, [new Date(), undefined, new Date(2017, 1, 1, 1, 1, 1, 1), new Date(2017, 1, 1, 1, 1, 1, 2), new Date(2017, 1, 1, 1, 1, 1, 3)])
...
test("AttributeTypes.DateTime.validate with {min:…}", ( assert ) => {
    ...
    typeValidateOk(assert, DateTime, options, [new Date(), undefined, new Date(2017, 1, 1, 1, 1, 1, 2), new Date(2017, 1, 1, 1, 1, 1, 3)])
    typeValidateEqual(assert, DateTime, options, 'is not a Date', ['33', '-32', '1', '-1', '0', '', '53.0', '2', '433', '-2', '3', '-3', '4', 'j', 'sada', '3.2', 'isds', 'sda sda ', 3.2, {}, () => {}, null, -32, -1, 0, -2, -3, 33, 53.0, 433, 3, 4, Date.now()])
...
test("AttributeTypes.DateTime.validate with {max:…}", ( assert ) => {
    ...
    typeValidateOk(assert, DateTime, options, [new Date(2017, 1, 1, 1, 1, 1, 1), undefined, new Date(2017, 1, 1, 1, 1, 1, 2)])
    typeValidateEqual(assert, DateTime, options, 'is not a Date', ['33', '-32', '1', '-1', '0', '', '53.0', '2', '433', '-2', '3', '-3', '4', 'j', 'sada', '3.2', 'isds', 'sda sda ', 3.2, {}, () => {}, null, -32, -1, 0, -2, -3, 33, 53.0, 433, 3, 4, Date.now()])
